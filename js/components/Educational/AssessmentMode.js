...
class AssessmentMode {
    ...
    checkExpressionAnswer(question, answer) {
        try {
            const parser = new ExpressionParser();
            
            // Normalize expressions
            const userNormalized = this.normalizeExpression(answer);
            ...
            // If not, check logical equivalence
            const userTable = parser.calculateTruthTable(answer, question.circuit.variables || question.variables);
            const correctTable = parser.calculateTruthTable(question.correctAnswer, question.circuit.variables || question.variables);
